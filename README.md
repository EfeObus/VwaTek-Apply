...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/AI-Gemini%203%20Flash-orange?style=flat-square&logo=google" alt="Gemini"/>
</p>
...
VwaTek Apply is a high-performance job application assistant built with **Kotlin Multiplatform**, delivering a native experience for **iOS, Android, and Web**. Powered by **Gemini 3 Flash**, it doesn't just write for you—it analyzes, optimizes, and coaches you through every stage of the hiring pipeline, from the initial "Apply" button to the final interview.
...
| Feature | Description |
|---------|-------------|
| **Match Scoring** | Compare your resume against specific job descriptions to get a compatibility percentage (similar to Jobscan) |
| **Keyword Gap Analysis** | Identify critical hard skills and industry-specific terms missing from your profile |
| **Impact Enhancement** | Rewrite passive experience entries into high-impact, metric-driven achievements |
...
| Feature | Description |
|---------|-------------|
| **PDF Export** | Professional formatting and instant export via native Share Sheet (iOS/Android) |
